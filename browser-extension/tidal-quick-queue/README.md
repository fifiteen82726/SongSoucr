...
This extension adds an inline icon button next to each visible TIDAL track link and sends that track URL directly to the local queue in the Electron app.
...
- Works for: `track`, `album`, `playlist`, `video` URLs
